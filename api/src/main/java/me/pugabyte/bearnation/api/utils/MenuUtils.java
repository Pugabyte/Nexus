...
public abstract class MenuUtils {
	...
	public static void handleException(Player player, Throwable ex) {
		if (ex.getCause() != null && ex.getCause() instanceof BNException)
			player.sendMessage(colorize(StringUtils.getPrefix("Menus") + "&c" + ex.getCause().getMessage()));
		else if (ex instanceof BNException)
			player.sendMessage(colorize(StringUtils.getPrefix("Menus") + "&c" + ex.getMessage()));
		else {
	...
	public static void openAnvilMenu(Plugin plugin, Player player, String text, BiFunction<Player, String, AnvilGUI.Response> onComplete, Consumer<Player> onClose) {
