...
public class SoundUtils {
	...
	public enum Jingle {
		...
		JOIN {
			...
			public void play(Player player) {
				int wait = 0;
				BNCore.tasks().wait(wait += 0, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.5F));
				BNCore.tasks().wait(wait += 2, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.667420F));
				BNCore.tasks().wait(wait += 2, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.749154F));
				BNCore.tasks().wait(wait += 2, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 1F));
			}
		},
		...
		QUIT {
			...
			public void play(Player player) {
				int wait = 0;
				BNCore.tasks().wait(wait += 0, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.707107F));
				BNCore.tasks().wait(wait += 4, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.629961F));
				BNCore.tasks().wait(wait += 4, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.707107F));
				BNCore.tasks().wait(wait += 4, () -> player.playSound(player.getLocation(), Sound.BLOCK_NOTE_BLOCK_HARP, SoundCategory.RECORDS, .5F, 0.529732F));
			}
		},
		...
		BATTLESHIP_MISS {
			...
			public void play(Player player){
				int wait = 0;
				BNCore.tasks().wait(wait += 0, () -> player.playSound(player.getLocation(), Sound.UI_TOAST_IN, 1, 1));
				BNCore.tasks().wait(wait += 9, () -> player.playSound(player.getLocation(), Sound.ENTITY_GENERIC_SPLASH, 1, 1));
			}
		},
		...
		BATTLESHIP_HIT {
			...
			public void play(Player player){
				int wait = 0;
				BNCore.tasks().wait(wait += 0, () -> player.playSound(player.getLocation(), Sound.UI_TOAST_IN, 1, 1));
				BNCore.tasks().wait(wait += 9, () -> player.playSound(player.getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 1, 1));
				BNCore.tasks().wait(wait += 8, () -> player.playSound(player.getLocation(), Sound.BLOCK_FIRE_AMBIENT, 1, 0.1F));
			}
		},
		...
		BATTLESHIP_SINK {
			...
			public void play(Player player){
				...
				BNCore.tasks().wait(wait += RandomUtils.randomInt(2, 5), () -> player.playSound(player.getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 1, 1));
				BNCore.tasks().wait(wait += RandomUtils.randomInt(1, 3), () -> player.playSound(player.getLocation(), Sound.ENTITY_GENERIC_EXPLODE, 1, 1));
				BNCore.tasks().wait(wait += RandomUtils.randomInt(1, 4), () -> player.playSound(player.getLocation(), Sound.ENTITY_GENERIC_SPLASH, 1, 1));
			}
		};
