...
public final class SignMenuFactory {
	...
	private static final Map<Player, Menu> inputReceivers = new HashMap<>();
	private static final Map<Player, BlockPosition> signLocations = new HashMap<>();
	...
	public static final class Menu {
		...
		public void open(Player player) {
			...
			signLocations.put(player, blockPosition);
			inputReceivers.putIfAbsent(player, this);
		}
	}
}
