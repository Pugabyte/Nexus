package me.pugabyte.bearnation.survival.features.dailyrewards;
...
import me.pugabyte.bearnation.models.dailyreward.DailyReward;
import me.pugabyte.bearnation.models.dailyreward.DailyRewardService;
import me.pugabyte.bearnation.models.dailyreward.Reward;
import me.pugabyte.bearnation.models.hours.Hours;
import me.pugabyte.bearnation.models.hours.HoursService;
		...
		Tasks.repeatAsync(Time.SECOND, Time.SECOND.x(5), () -> {
			for (Player player : Bukkit.getOnlinePlayers()) {
				try {
					...
					BNPlugin.warn("Error in DailyRewards scheduler: " + ex.getMessage());
				}
			}
		});
	}
