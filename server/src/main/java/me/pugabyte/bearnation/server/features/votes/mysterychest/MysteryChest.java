package me.pugabyte.bearnation.server.features.votes.mysterychest;
...
import me.pugabyte.bearnation.features.menus.rewardchests.RewardChestLoot;
import me.pugabyte.bearnation.features.menus.rewardchests.RewardChestType;
import me.pugabyte.bearnation.server.models.mysterychest.MysteryChestPlayer;
import me.pugabyte.bearnation.server.models.mysterychest.MysteryChestService;
	...
	public static int getNextId() {
		...
		for (String section : sections) {
			try {
				...
				BNPlugin.warn("An error occurred while trying to save a Mystery Chest to file");
				ex.printStackTrace();
			}
		}
		return id;
