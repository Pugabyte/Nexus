package me.pugabyte.bearnation.minigames.features.lobby;
...
import me.pugabyte.bearnation.minigames.features.commands.PodiumsCommand;
import me.pugabyte.bearnation.minigames.features.commands.PodiumsCommand.Position;
import me.pugabyte.bearnation.minigames.features.utils.MinigameNight.NextMGN;
...
import static me.pugabyte.bearnation.api.utils.Utils.isNPC;
...
public class ActionBar {
	...
	public ActionBar() {
		Minigames.tasks().repeat(5, messages.size() * DELAY, () -> {
			AtomicInteger wait = new AtomicInteger(0);
			messages.iterator().forEachRemaining(message ->
					Minigames.tasks().wait(wait.getAndAdd(DELAY), () ->
