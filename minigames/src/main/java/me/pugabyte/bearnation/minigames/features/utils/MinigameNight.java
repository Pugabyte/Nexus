package me.pugabyte.bearnation.minigames.features.utils;
...
import static me.pugabyte.bearnation.api.utils.StringUtils.getNumberWithSuffix;
...
public class MinigameNight {
	...
	public static class NextMGN {
		...
		public NextMGN(OfflinePlayer player) {
			this(ZoneId.of(((GeoIP) new GeoIPService(Minigames.inst()).get(player)).getTimezone().getId()));
		}
