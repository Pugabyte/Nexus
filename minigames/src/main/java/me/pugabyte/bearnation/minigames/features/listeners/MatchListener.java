...
import static me.pugabyte.bearnation.api.utils.Utils.runCommandAsOp;
...
public class MatchListener implements Listener {
	...
	private void registerWaterDamageTask() {
		...
		Minigames.tasks().repeat(Time.SECOND, Time.SECOND, () ->
	...
	public void onTeleport(PlayerTeleportEvent event) {
		...
		event.setCancelled(true);
		Minigames.log("Minigamer tried to teleport to " + event.getTo() + " but was denied");
