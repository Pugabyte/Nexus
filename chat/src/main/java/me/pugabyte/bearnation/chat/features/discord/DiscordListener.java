package me.pugabyte.bearnation.chat.features.discord;
...
import me.pugabyte.bearnation.chat.models.discord.DiscordCaptcha;
import me.pugabyte.bearnation.chat.models.discord.DiscordCaptcha.CaptchaResult;
import me.pugabyte.bearnation.chat.models.discord.DiscordCaptchaService;
...
import me.pugabyte.bearnation.features.discord.DiscordId.Channel;
import me.pugabyte.bearnation.features.discord.DiscordId.Role;
import me.pugabyte.bearnation.features.discord.DiscordId.User;
	...
	public void onPrivateMessageReactionAdd(@Nonnull PrivateMessageReactionAddEvent event) {
		Tasks.async(() -> {
			if (event.getUser() == null) {
				BNPlugin.log("[Captcha] Received reaction from null user");
				return;
			}
			...
			if (result == CaptchaResult.UNCONFIRMED) {
				...
				if (member == null) {
					...
					if (message == null)
						BNPlugin.warn("[Captcha] Could not find original message");
					else
